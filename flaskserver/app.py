  ...
  if request.method == 'POST':
    ...
    if user:
        if bcrypt.check_password_hash(user.password,password):
            ...
            return make_response ('Couldnot Verify111',401,{'WWW-Aunthentication': 'Basic realm: "Login Required !!!"'})


    return make_response ('Couldnot Verify boss',401,{'WWW-Aunthentication': 'Basic realm: "Login Required !!!"'})
